...
class AlbProofs extends FlatSpec with Prover { 
	...
	////////////////////////////////////////////////////////////
	// PROOFS FOR UPDATABLE ATTRIBUTES OF ELEMENT - specified in object TableName extends CvRDTProof 
	////////////////////////////////////////////////////////////
	...
	"Albs_FK_System" should "maintain referential integrity generic proof" in {
